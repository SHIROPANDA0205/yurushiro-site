...
export const profile = {
  ...
  items: [
    ...
    { label: "興味分野", value: "AI活用、Web制作、業務効率化、IT副業" },
    { label: "将来の目標", value: "起業して、さまざまな方と仕事をすること" },
  ] as ProfileItem[],
  bio: [
    "早稲田大学大学院（先進理工学研究科 生命理工学専攻）を修了した、少し異色の経歴を持つITエンジニアです。",
    ...
    "そう感じ、本業のかたわらClaude Codeを中心としたAI活用開発を始め、IT副業としてもWeb制作やAI活用支援のご相談を受けています。",
