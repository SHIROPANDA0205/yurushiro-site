...
export const profile = {
  ...
  /** /company に載せる本文 */
  bio: [
    "早稲田大学大学院（先進理工学研究科 生命理工学専攻）を修了した、少し異色の経歴を持つエンジニアです。生物学の研究から情報技術の世界に移り、現在は大手IT企業でローコード開発を中心に業務システムの開発に携わっています。",
...
export const homeBio: string[] = [
  "早稲田大学大学院（先進理工学研究科）を修了した、少し異色の経歴を持つエンジニアです。生物学の研究から情報技術の世界に移り、現在は大手IT企業でローコード開発を中心に業務システムの開発に携わっています。",
